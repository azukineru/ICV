...
<body class="mapstyle-segment">
  <div class="off-canvas-wrapper">
    <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
      ...
      <div class="large-3 position-left reveal-for-large my-info dashboard-C" data-off-canvas data-position="left">
        <div class="row">
      ...
      <div class="large-9 float-right" data-off-canvas-content>
        ...
        <div class="row large-12">
          ...
          if (isset($_POST["search"]) && !empty($_POST["HS"]) && !empty($_POST["SOC"])){
            searchparam('C',$_POST["HS"],$_POST["SOC"],$_POST["BF"]);
            echo "
            <style type='text/css'>
              #first-column{
              display: block;
      ...
      <?php     
                if (isset($_POST["search"]) && !empty($_POST["HS"]) && !empty($_POST["SOC"])) {         
                  overview('C',$_POST["HS"],$_POST["SOC"],$_POST["BF"]);            
                }
                ?>      
            ...
            <div class="scroll-box">
              <table class="table-cluster">
                <tbody>
                  <?php     
                  if (isset($_POST["search"]) && !empty($_POST["HS"]) && !empty($_POST["SOC"])) {         
                    clusterlist('C',$_POST["HS"],$_POST["SOC"],$_POST["BF"]);              
                  }
                  ?>
                </tbody>
              </table>
        ...
        <div id="third-column" class="column large-4">
          <div class="inner">
            ...
            <?php     
            if (isset($_POST["search"]) && !empty($_POST["HS"]) && !empty($_POST["SOC"])) {         
              odclist('C',$_POST["HS"],$_POST["SOC"],$_POST["BF"]);              
            }
            ?>
          </div>
        </div>
